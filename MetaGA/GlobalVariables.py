...
minPortfolioSize = 20                            # This is the minimum size of portfolio
...
endDate = datetime(2012, 1, 20).date()           # This is the end of trading period
testingStartDate = endDate + timedelta(days=1)
testingEndDate = datetime(2012, 1, 31).date()
