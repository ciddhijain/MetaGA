...
logFileName = 'MetaGA09.log'                      # This is the name of log file. It will append if file already exists
mappingOutfileName = 'mapping09.csv'
performanceOutfileName = 'performance09.csv'
bestPerformanceOutfileName = 'bestPerformance09.csv'
...
mutationProbability = 0.075                      # This is the mutation probability

numPortfolios = 1000                             # This is the number of portfolios in one generation
